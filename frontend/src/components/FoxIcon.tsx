// ============================================================================
// FoxIcon.tsx — Fuchscher Maskottchen: geometrischer Fuchskopf als SVG.
// ============================================================================
// Selbst gezeichnet (kein Lizenz-Stibitzen nötig): Silhouette mit spitzen
// Ohren, halbtransparenten Innenohren, Augen und Nase als Negativform.
// Färbt sich via currentColor — passt damit automatisch ins Theme.
